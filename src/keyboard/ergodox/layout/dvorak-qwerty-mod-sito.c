...
KB_MATRIX_LAYER(
  ...
  0x2F, KEY_SingleQuote_DoubleQuote,  KEY_Comma_LessThan, KEY_Period_GreaterThan, KEY_p_P,  KEY_y_Y,  0,  
  KEY_LeftBracket_LeftBrace,  KEY_a_A,  KEY_o_O,  KEY_e_E,  KEY_u_U,  KEY_i_I,  
  KEYPAD_LeftParenthesis,  KEY_Semicolon_Colon,  KEY_q_Q,  KEY_j_J,  KEY_k_K,  KEY_x_X,  0,  
                          0,  KEY_LeftControl,  KEY_LeftAlt,  KEY_LeftGUI,  KEY_LeftShift,  
                                                          0,  0,  
                                                          0,  0,  0,  
  ...
  // right hand
              ...
              0,  KEY_f_F,  KEY_g_G,  KEY_c_C,  KEY_r_R,  KEY_l_L,  0x30, 
                  KEY_d_D,  KEY_h_H,  KEY_t_T,  KEY_n_N,  KEY_s_S,  KEY_RightBracket_RightBrace,  
              0,  KEY_b_B,  KEY_m_M,  KEY_w_W,  KEY_v_V,  KEY_z_Z,  KEYPAD_RightParenthesis, 
...
KB_MATRIX_LAYER(
  ...
  // right hand
              ...
              NULL, kprrel, kprrel, kprrel, kprrel, kprrel, sshprre,  
                    kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, 
